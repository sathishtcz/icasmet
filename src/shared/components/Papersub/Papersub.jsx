                ...
                <section>
                    <div className="container mx-auto px-4 py-8">
                        <div className="text-center mb-12">
                            <span className="inline-block px-4 py-2 bg-blue-100 text-blue-600 rounded-full text-sm font-semibold mb-4">PAPER SUBMISSION</span>
                            <h2 className="md:text-4xl text-2xl font-bold text-gray-800 mb-4">
                                Be a Part of ICASMET 2025
                            </h2>
                            <p className="sm:text-base md:text-lg lg:text-[16px] text-gray-900 leading-relaxed mx-auto text-justify">
                                Participants are invited to submit high-quality, original research papers that have not been published or presented elsewhere. Submissions should align with the conference tracks and demonstrate significant contributions to applied science, multidisciplinary engineering, and technology. All papers will undergo a rigorous peer-review process to ensure relevance, innovation, and academic integrity. Accepted papers will be included in the official conference proceedings and may be considered for publication in associated journals or indexed databases. Authors are encouraged to follow the prescribed formatting guidelines and submit their work within the specified deadlines.
                            </p>
                        </div>
                        ...
                        <div className="max-w-7xl mx-auto  grid grid-cols-1 lg:grid-cols-2 gap-10">
                            ...
                            <div className="bg-gradient-to-br from-blue-50 to-white p-8 rounded-2xl border border-gray-200">
                                <h3 className="text-2xl font-bold text-blue-700 mb-8">Submission Guidelines</h3>
                                <div className="space-y-6">
                                    {[
                                        ...
                                        <div key={index} className="flex items-start">
                                            <div className="flex-shrink-0 w-8 h-8 rounded-full bg-blue-600 text-white flex items-center justify-center font-semibold shadow-md">
                                                {index + 1}
                                            </div>
                            ...
                            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-200">
                                <h3 className="text-2xl font-bold text-blue-700 mb-6">Submit Your Paper</h3>
                                <form className="space-y-6" onSubmit={handleSubmit}>

                                    <input
                                        placeholder="Paper Title"
                                        required
                                        className="w-full px-5 py-3 border rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none bg-gray-50"
                                        type="text"
                                        name="Paper_Title"
                                    ...
                                    <select
                                        ...
                                        onChange={handleFileInputChange}
                                        required
                                        className="w-full px-5 py-3 border rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none bg-white"
                                    >
                                    ...
                                    <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:bg-gray-50 transition">
                                        <label className="cursor-pointer flex flex-col items-center">
                                            ...
                                            <p>{fileName || "Click to Upload Paper"}</p>
                                        </label>
                                    </div>

                                    <button
                                        type="submit"
                                        className="w-full bg-blue-700 text-white font-semibold py-4 rounded-lg hover:bg-blue-600 transition duration-300 text-lg cursor-pointer"
                                    >
